...
konfig-manager/1.4.3 darwin-x64 node-v10.16.0
$ konfig --help [COMMAND]
USAGE
  $ konfig COMMAND
...
...
_See code: [src/commands/dump.js](https://github.com/LuanP/konfig-manager/blob/v1.4.3/src/commands/dump.js)_
...
_See code: [src/commands/flush.js](https://github.com/LuanP/konfig-manager/blob/v1.4.3/src/commands/flush.js)_
...
_See code: [src/commands/load.js](https://github.com/LuanP/konfig-manager/blob/v1.4.3/src/commands/load.js)_
...
_See code: [src/commands/sync.js](https://github.com/LuanP/konfig-manager/blob/v1.4.3/src/commands/sync.js)_
<!-- commandsstop -->
